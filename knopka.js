...
function calc() {
	...
	if (isNaN(Number(mass))){
		alert("Enter an integer of your body weight!")
		document.getElementById("ves").style.backgroundColor = "#ffbdbd";
	} else if(isNaN(Number(vozrast))){
		alert("Enter the correct age!")
		document.getElementById("vozr").style.backgroundColor = "#ffbdbd";
	} else{
	if($("#por").val() == ""){
  		alert("Fill out all the items!");
  		document.getElementById("por").style.backgroundColor = "#ffbdbd";
	} else if($("#vozr").val() == ""){
		document.getElementById("vozr").style.backgroundColor = "#ffbdbd";
		alert("Fill out all the items!");
	}else if($("#ves").val() == ""){
		...
		document.getElementById("she").style.backgroundColor = "#ffbdbd";
		alert("Fill out all the items!");
	}else if(document.getElementById("mot").value == ""){
		document.getElementById("mot").style.backgroundColor = "#ffbdbd";
		alert("Fill out all the items!");
	}else if(document.getElementById("has").value == ""){
		document.getElementById("has").style.backgroundColor = "#ffbdbd";
		alert("Fill out all the items!");
	}else if($("#food1").val() == ""){
		document.getElementById("food1").style.backgroundColor = "#ffbdbd";
	alert("Fill out all the items!");
	}else if(document.getElementById("castr").value == ""){
		document.getElementById("castr").style.backgroundColor = "#ffbdbd";
		alert("Fill out all the items!");
	}else if(document.getElementById("scr").value == ""){
		document.getElementById("scr").style.backgroundColor = "#ffbdbd";
		alert("Fill out all the items!");
	}else if(document.getElementById("sl").value == ""){
		document.getElementById("sl").style.backgroundColor = "#ffbdbd";
		alert("Fill out all the items!");
	}else if(document.getElementById("select22").value == ""){
		document.getElementById("select22").style.backgroundColor = "#ffbdbd";
		alert("Fill out all the items!");
	}else if(document.getElementById("ideal").value == ""){
		document.getElementById("ideal").style.backgroundColor = "#ffbdbd";
	alert("Fill out all the items!");
	}else if(rt == false){
		alert("Select the activity level of the dog!");
	}else if(tr == false){
		alert("Select the eating style of the dog!");
	}else{
	document.getElementById("ideal").style.backgroundColor = "white";
	document.getElementById("scr").style.backgroundColor = "white";
	document.getElementById("sl").style.backgroundColor = "white";
	document.getElementById("food1").style.backgroundColor = "white";
	document.getElementById("castr").style.backgroundColor = "white";
	document.getElementById("select22").style.backgroundColor = "white";
	document.getElementById("has").style.backgroundColor = "white";
	document.getElementById("mot").style.backgroundColor = "white";
	document.getElementById("she").style.backgroundColor = "white";
	document.getElementById("por").style.backgroundColor = "white";
	document.getElementById("vozr").style.backgroundColor = "white";
	document.getElementById("ves").style.backgroundColor = "white";
	iu = $('#mot').val();
	vozrast = Number(document.getElementById("vozr").value);
	vozrast = String(Math.round(vozrast));
	castr = $('#castr').val();
	mass = $('#ves').val();
	mass = Number(mass);
...
function handleButtonClick1() {
	if($(".names").val() == ""){
  		alert("Fill out all the items!");
  		document.getElementsByClassName("names")[0].style.backgroundColor = "#ffbdbd";
	} else if($(".name_dog1").val() == ""){
		document.getElementsByClassName("name_dog1")[0].style.backgroundColor = "#ffbdbd";
		alert("Fill out all the items!");
	} else if($(".email1").val() == ""){
		document.getElementsByClassName("email1")[0].style.backgroundColor = "#ffbdbd";
		alert("Fill out all the items!");
	}else if($(".zip_int").val() == ""){
		alert("Fill out all the items!");
		document.getElementsByClassName("zip_int")[0].style.backgroundColor = "#ffbdbd";
	}else if($(".email1").val() == ""){
		alert("Fill out all the items!");
	}else if(document.getElementById("select11").value == ""){
		document.getElementById("select11").style.backgroundColor = "#ffbdbd";
		alert("Fill out all the items!");
	}else{
		document.getElementById("select11").style.backgroundColor = "white";
		document.getElementsByClassName("zip_int")[0].style.backgroundColor = "white";
		document.getElementsByClassName("name_dog1")[0].style.backgroundColor = "white";
		document.getElementsByClassName("email1")[0].style.backgroundColor = "white";
		document.getElementsByClassName("names")[0].style.backgroundColor = "white";
...
function handleButtonClick3() {
	...
	alert("The email has been sent to your email address!(if you didn`t see it, check your spam folder")
} else{
	alert("Choose at least one taste!")
}
}
